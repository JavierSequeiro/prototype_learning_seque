if __name__ == '__main__':
    ...
    transform = False
    feature = "Posterior_features" #"Margin"
    ...
    # push set
    # train_push_dataset = USG_Dataset(train_push_dir, train_mask_dir, is_train=True,is_push=True,number_classes=num_classes)
    train_push_dataset = USG_Dataset(root_dir=root_dir,
                      mode="train",
                      is_push=True,
                      excel_file=excel_file,
                      feature=feature,
    ...
    # mode = "val"
    # test_dataset = USG_Dataset(test_dir, mask_dir=test_mask_dir, is_train=False,number_classes=num_classes)
